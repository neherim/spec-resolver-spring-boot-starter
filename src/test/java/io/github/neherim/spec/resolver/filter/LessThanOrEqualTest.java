...
public class LessThanOrEqualTest extends BaseContextTest {

    public static final String SEARCH_URL = "/less-than-or-equal";
    @Autowired
    TestRepo testRepo;
    ...
    void findByDateField() throws Exception {
        mockMvc.perform(get(SEARCH_URL + "?dateTo=2023-11-11"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$").isArray())
    ...
    public static class TestEntity {
        @Id
        @Filter(name = "idTo", filter = LessThanOrEqual.class)
        public Integer id;
        @Filter(name = "dateTo", filter = LessThanOrEqual.class)
